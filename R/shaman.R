...
#' @export
##########################################################################################################
shaman_shuffle_hic_track <- function(track_db, obs_track_nm, work_dir, exp_track_nm=paste0(obs_track_nm, "_shuffle"),
    ...
    dist_resolution=NA, smooth=NA)
{
   ...
   shuffle_exe = sprintf("%s/%s", system.file("bin", package="shaman"), getOption("shaman.shuffle_exe"))
    ...
    commands <- paste0("{library(shaman); shaman_shuffle_hic_mat_for_track(\"", track_db, "\",\"", obs_track_nm, "\",\"", work_dir,
