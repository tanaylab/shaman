...
### Requirements 
- _Perl_
- _remotes_ R package (optional, for automatic installation of *bioconductor* dependencies)
...
If remotes fails to install all the bioconductor requirments please install _Gviz_ and _GenomeInfoDb_ manually from bioconductor:
