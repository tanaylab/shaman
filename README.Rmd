...
https://github.org/tanaylab/shaman

### Requirements 
- _Perl_
- _devtools_ R package (optional, for automatic installation of *bioconductor* dependencies)
...
```{r, eval = FALSE}
devtools::install_github('tanaylab/shaman@default', 
                            vignette = TRUE, 
                            repos=c(getOption('repos'), 'https://tanaylab.github.io/repo'))
```

If devtools fails to install all the bioconductor requirments please install _Gviz_ and _GenomeInfoDb_ manually from bioconductor:
