...
shaman_plot_map_score_with_annotations("hg19", point_score$points, gintervals.2d(2, 175e06, 178e06, 2, 175e06, 178e06), misha_tracks=list("K562.k27ac", "rna-seq"), annotations=list("ctcf_forward", "ctcf_reverse"), a_colors=c("#4572A7", "#AA4643"))
```
